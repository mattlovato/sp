...
if (!$_SESSION['geoip_fetched']) {
	...
	$_SESSION['geoip_fetched'] = true;
	
	
	$_SESSION['inferred_state'] = $location[1];
	$_SESSION['inferred_city'] = $location[2];
	$_SESSION['inferred_company'] = $location[9];
	$_SESSION['inferred_country'] = $inferred_country;
}

$inferred_state = $_SESSION['inferred_state'];
$inferred_city = $_SESSION['inferred_city'];
$inferred_company = $_SESSION['inferred_company'];
$inferred_country = $_SESSION['inferred_country'];
?> 
