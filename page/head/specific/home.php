<meta name="description" content="A unique cloud-based file sharing and social collaboration platform that helps teams work together, access shared content, and record a project’s progress all on a single page.">
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($) {
		...
		$("#popover3").popover({
			...
			content: "<ul><li><hr />Comment on anything and instantly deliver the message to all the right people with a single click, all necessary links included.<br /><br /><a href='/cloud/social-business/' class='bold'><img src='/cloud/img/plus-button.png?v=4ed595a346c1db8057c9911e8d6c0d65617d6286' style='width:12px;' alt='Learn more'   width='12' height='12'/> Learn more</a> </li></ul>",
			trigger: 'manual',
			position:'left'
		});
		...
		$("#popover5").popover({
			...
			content: "<ul><li><hr />Surround your files and conversations with calendars, task lists and other team coordination tools.<br /><br /><a href='/cloud/same-page/' class='bold'><img src='/cloud/img/plus-button.png?v=4ed595a346c1db8057c9911e8d6c0d65617d6286' style='width:12px;' alt='Learn more'   width='12' height='12'/> Learn more</a> </li></ul>",
			trigger: 'manual',
			position:'right'
