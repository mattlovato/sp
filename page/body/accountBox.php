<div id="signuptext" class="loginblock">
	...
	<div id="pricing" class="loginblock">
   	  <div class="login-frame">
        <div class="createaccount createAccountTop">
    ...
    <div id="signup" class="loginblock">
      <div class="login-frame">
        <div class="createaccount createAccountTop">
          <div class="createAccountWrapTop">
            <div class="pricingWrapper">
              <div class="kerioForm signupBlock blueglow signup_top">
                <?php include('./cloud/forms/signup_form.php'); ?>
              </div>
              <div class="learnpricing">Learn more about <a href="" rel="expand[pricing]">pricing</a></div>
            </div>
          </div>
        </div>
