<div id="body-frame">
	...
	<div style="display:inline-block;margin-right:33px;margin-left:15px;">
		<a class="box" href="" id="slide1" title="File Sharing" >
			<?php
			if ($SPdevice == 'Desktop')
				echo '<div class="boxbghover" ><img class="bottom" src="/cloud/img/home-box-hover1.png?v=" alt="box" width="262" height="110"/></div>';
			?>
			<img src="/cloud/img/home-box.png?v=" class="boxbg bottom" alt="box" width="262" height="110"/>
			<div id="box1-on" style="display:none;position:absolute;margin-top:-84px;margin-left:-10px;">
				<img src="/cloud/img/home-box-hover1.png?v=" alt="box" width="262" height="110"/>
			</div>
			...
			<div class="background_cycle">
				<div class="headlineblock">
					...
					<div class="subheadline brown">Access, edit, and share the most current version of any file, anytime, anywhere.
                        <a href="/cloud/file-sharing/" title="File Sharing"><div class="learnmore"><img src="/cloud/img/plus-button.png?v="  alt="Learn more" width="35" height="35"/><span class="learnmoretext">Learn more</span></div></a>
					</div>
					<img src="/cloud/img/file-sharing-folder.png?v=" width="329" height="315" style="bottom:140px;position:absolute;margin-left:-20px;border:none;" alt="File sharing icon"/>
				</div>
			</div>
		</div>
	</li>
			...
			<div class="background_cycle">
				...
				echo 'margin-left:554px;';
					...
					<div class="home-screenshot" <?php if ($SPbrowser_type != 'IE') echo 'style="-moz-transform: scaleX(-1);-o-transform: scaleX(-1);-webkit-transform:scaleX(-1);transform: scaleX(-1);filter:FlipH; margin-left:4px;"'; ?> > 
						<img src="/cloud/img/samepage-screenshot-sync.jpg?v=" alt="File sharing screenshot" class="home-screenshot-inner" width="805" height="499"/>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="background_cycle">
				<div class="headlineblock">
					...
					<div class="subheadline aqua">No more drafting emails, attaching files, and repeatedly selecting the same recipients.
                        <a href="/cloud/social-business/" title="Social for Business"><div class="learnmore"><img src="/cloud/img/plus-button.png?v="  alt="Learn more"  width="35" height="35"/><span class="learnmoretext">Learn more</span></div></a>
					</div>
					<img src="/cloud/img/comments-icon.png?v="  style="bottom:170px;position:absolute;margin-left:0px;z-index:999;border:none;" alt="Social for business icon" width="289" height="303"/>	
				</div>
			</div>
		</div>
	</li>
		...
		<div  class="room bg2 transform">
			<div class="background_cycle">
				...
				echo 'margin-left:539px;';
					...
					<div class="home-screenshot" <?php if ($SPbrowser_type != 'IE') echo 'style="-moz-transform: scaleX(-1);-o-transform: scaleX(-1);-webkit-transform:scaleX(-1);transform: scaleX(-1);filter:FlipH; margin-left:4px;"'; ?> > 
						<img src="/cloud/img/samepage-screenshot-comment.jpg?v=" alt="File sharing screenshot" class="home-screenshot-inner" width="805" height="499"/>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="background_cycle">
				<div class="headlineblock">
					...
					<div class="subheadline navy">Create a new page, invite contributors, and record your progress from start to finish.
                        <a href="/cloud/same-page/" title="On The Same Page"><div class="learnmore"><img src="/cloud/img/plus-button.png?v=" alt="Learn more"  width="35" height="35"/><span class="learnmoretext">Learn more</span></div></a>
					</div>
					<img src="/cloud/img/samepage-icon.png?v="  style="bottom:150px;position:absolute;margin-left:-10px;z-index:999;border:none;" alt="Samepage icon"   width="323" height="303"/>
				</div>
			</div>
		</div>
	</li>
		...
		<div  class="room bg3 transform">
			<div class="background_cycle">
				...
				echo 'margin-left:554px;';
					...
					<div class="home-screenshot" <?php if ($SPbrowser_type != 'IE') echo 'style="-moz-transform: scaleX(-1);-o-transform: scaleX(-1);-webkit-transform:scaleX(-1);transform: scaleX(-1);filter:FlipH; margin-left:4px;"'; ?> > 
						<img src="/cloud/img/samepage-screenshot-samepage.jpg?v=" alt="Same page screenshot" class="home-screenshot-inner"   width="805" height="499"/>
					</div>
				</div>
			</div>
		</div>
