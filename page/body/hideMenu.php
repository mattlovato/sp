...
<div id="hidemenu">
    <div id="hidemenu-frame">
        ...
        <img src="/cloud/img/vert-divider-green.png?v=" class="vertgreendivide"/> 
		...
		<?php
		if ($SPdevice == 'Desktop') {
			echo '<div class="menuwatermarkhover"><a href="/cloud"><img class="bottom" src="/cloud/img/samepage-watermark100.png?v="/></a></div>';
		}
		?>
        <a href="/cloud/"><img src="/cloud/img/samepage-watermark.png?v=" alt="Samepage" class="menuwatermark bottom"/></a> 
    </div>    
	<div style="z-index:999;background-image: url('/cloud/img/preheader-shadow.png?v=');background-repeat:repeat-x;margin-left:auto;margin-right:auto;width:850px;height:9px;">&nbsp;</div>
</div>